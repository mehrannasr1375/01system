<!-- main slider -->
<section id="slider">
    <div id="top-carousel" class="carousel slide" data-ride="carousel" data-pause="false" data-interval="<?=SLIDER_INTERVAL?>">
            ...
            <div class="carousel-item active" style="background-image: url('./includes/images/slider/s1.jpg"?>')">
                <div class="carousel-overlay">
                    <div class="carousel-content text-center wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <p class="carousel-text">طراحی و پیاده سازی انواع CMS ها، وبسایت ها، پایگاه های داده و اپلیکیشن های تحت وب با رعایت اصول مهندسی نرم افزار و امنیت بالا</p>
                    </div>
                </div>
            </div>
            <div class="carousel-item " style="background-image: url('./includes/images/slider/s3.jpg')">
                <div class="carousel-overlay">
                    <div class="carousel-content text-center wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <p class="carousel-text">طراحی واکنشگرا یک روش طراحی وب است که هدف از آن نمایش مناسب صفحه ی وب در طیف گسترده‌ای از دستگاه‌ها، (از تلفن‌های همراه گرفته تا نمایشگرهای بزرگ و عریض) می باشد.</p>
                    </div>
                </div>
            </div>
            <div class="carousel-item " style="background-image: url('./includes/images/slider/s2.jpg')">
                <div class="carousel-overlay">
                    <div class="carousel-content text-center wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <p class="carousel-text">کسب و کار و خدمات خود را با وب سایت شخصی توسعه دهید!</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row position-relative">
            ...
            <div class="card col-12 col-md-4 col-lg-3 wow fadeInUp" data-wow-delay="1.0s">
                ...
                <div class="card-body text-center">
                    ...
                    <hr class="bg-white-50"/>
                    <p class="sm-font text-white-50">تست و بررسی عملکرد وبسایت از نظر سرعت، امنیت و واکنش پذیری آن در صفحات نمایش گوناگون با ابزارها و وب سایت های معتبر در این زمینه و در نهایت قرار دادن وب سایت روی هاست.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
                <div class="card-2">
                    ...
                    <div class="card-body text-center">
                        ...
                        <hr/>
                        <p class="sm-font text-black-50">طراحی و پیاده سازی انواع سیستم های مدیریت محتوا از طراحی دیتابیس تا تست و بررسی نهایی.</p>
                     </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.6s">
                <div class="card-2">
                    ...
                    <div class="card-body text-center ">
                        ...
                        <hr/>
                        <p class="sm-font text-black-50">طراحی و پیاده سازی انواع وب سایت ها با به روزترین ویژگی ها و شیک ترین رابط ها.</p>
                     </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.8s">
                <div class="card-2">
                    ...
                    <div class="card-body text-center ">
                        ...
                        <hr/>
                        <p class="sm-font text-black-50">پیاده سازی انواع پروژه های تحت وب به زبان ها و فریمورک های مختلف، از جمله php، asp، node.js، laravel و ...</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="1.0s">
                <div class="card-2">
                    ...
                    <div class="card-body text-center">
                        ...
                        <hr/>
                        <p class="sm-font text-black-50">طراحی و پیاده سازی و پشتیبانی از انواع پایگاه های داده متناسب با کاربردهای خاص.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="samples-slider-container">
            <div class="box wow fadeIn">
                ...
                <span class="text-caption-sm">در 25 روز</span>
            </div>
            ...
            <div class="box wow fadeIn" data-wow-delay="0.6s">
                ...
                <span class="text-caption-sm">در 60 روز</span>
            </div>
        </div>
    </div>
</div>
