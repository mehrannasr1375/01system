...
<div id="new-post" class="part row">
    ...
    <div class="new-post-right col-9">
        ...
        <div class="d-flex justify-content-start pt-2">
            ...
            <span id="title">ایجاد پست جدید</span>
        </div>
        <hr>
        ...
        <div id="newpost">
            ...
            <!-- Post hidden id -->
            <input type="hidden" id="update_post_id" value="" />
            ...
            <div class="form-group my-5">
                <input type="text" class="form-control" name="p_title" autocomplete="off" placeholder="عنوان پست" />
            </div>


            <!-- Post Body -->
            <div class="form-group mb-5">
                <textarea class="form-control" id="area" name="p_content"></textarea>
            </div>
                            ...
                            if ($cats = PostMeta::allCategoriesByParent(0)) {
                                foreach ($cats as $cat) {
                                    ...
                                    <div class="custom-control custom-checkbox shifttoleft1">
                                        <input type="checkbox" name="cats[]" class="custom-control-input" id="<?= $cat->id ?>" value="<?= $cat->id ?>" />
                            ...
                            if ($tags = PostMeta::allTags()) {
                                foreach ($tags as $tag) {
                                    ...
                                    <div class="custom-control custom-checkbox shifttoleft-tag">
                                        <input type="checkbox" name="tags[]" class="custom-control-input" id="<?= $tag->id ?>" value="<?= $tag->id ?>" />
    ...
    <div class="new-post-left col-3">
            ...
            <div class="n-p-l-body">
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <div class="custom-control custom-checkbox pr-0" style="direction: ltr !important;">
                        <input type="checkbox" class="custom-control-input" id="chk_published" name="chk_published" checked />
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <div class="custom-control custom-checkbox pr-0" style="direction: ltr !important;">
                        <input type="checkbox" class="custom-control-input" id="chk_allow_comments" name="chk_allow_comments" checked />
                ...
                <div class="d-flex justify-content-start flex-column mb-3">
                    ...
                    <div class="mr-4 p-2 border-right" style="border-width: 3px !important;">
                        ...
                        <div class="custom-control custom-radio text-vvsm">
                            <input type="radio" class="custom-control-input" id="rdo_visibility-all" name="rdo_access_level" value="0" checked>
                            <label class="custom-control-label" for="rdo_visibility-all">تمامی کاربران</label>
                        </div>
                        <div class="custom-control custom-radio text-vvsm">
                            <input type="radio" class="custom-control-input" id="rdo_visibility-admins" name="rdo_access_level" value="1">
                            <label class="custom-control-label" for="rdo_visibility-admins">مدیرها</label>
                        </div>
                        <div class="custom-control custom-radio text-vvsm">
                            <input type="radio" class="custom-control-input" id="rdo_visibility-editors" name="rdo_access_level" value="2">
                            <label class="custom-control-label" for="rdo_visibility-editors"> ویرایشگرها</label>
                        </div>
                        <div class="custom-control custom-radio text-vvsm">
                            <input type="radio" class="custom-control-input" id="rdo_visibility-admins-editors" name="rdo_access_level" value="3">
        ...
        <div class="new-post-left-part">
            ...
            <div class="n-p-l-body">
                ...
                <!-- image name variable -->
                <input type="hidden" name="post-img-name" id="post-img-name" />
                <!-- result text -->
